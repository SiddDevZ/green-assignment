          ...
          <div className="max-w-4xl mx-auto mb-20">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
              <div className="order-2 md:order-1 relative h-[400px]">
                <Image 
                  src="https://images.unsplash.com/photo-1589391886807-1921526b4cdb?q=80&w=1974&auto=format&fit=crop"
      ...
      <section className="py-20 bg-[#2c3a2a] text-white text-center">
        <div className="container mx-auto px-6">
          ...
          <Link href="/collections">
            <button className="bg-white text-[#2c3a2a] px-8 py-3 text-sm uppercase tracking-widest font-medium hover:bg-[#e8ede4] transition-all duration-300">
