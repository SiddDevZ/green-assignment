        ...
        <div className="container mx-auto px-6 z-10 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link href="/collections">
              <button className="bg-[#e8ede4] text-[#2c3a2a] px-8 py-3 text-sm uppercase tracking-widest font-medium hover:bg-[#d1dbc9] transition-all duration-300 cursor-pointer">
                Discover Collection
              </button>
            </Link>
            <Link href="/story">
              <button className="bg-transparent border-2 border-white text-white px-8 py-3 text-sm uppercase tracking-widest font-medium hover:bg-white/10 transition-all duration-300 cursor-pointer">
                Our Story
              </button>
            </Link>
          </div>
      ...
      <section className="py-24 bg-[#f2f5f0]">
        <div className="container mx-auto px-6">
            ...
            <div className="bg-white p-6 group hover:shadow-lg transition-all duration-300">
              ...
              <div className="flex justify-between items-center">
                ...
                <Link href="/collections/organic-cotton-sheet-set">
                  <button className="text-sm text-[#2c3a2a] font-medium border-b border-[#2c3a2a] hover:border-transparent transition-all cursor-pointer">
                    View Details
                  </button>
                </Link>
              </div>
          ...
          <div className="text-center mt-16">
            <Link href="/collections">
              <button className="border-2 border-[#2c3a2a] text-[#2c3a2a] px-8 py-3 text-sm uppercase tracking-widest font-medium hover:bg-[#2c3a2a] hover:text-white transition-all duration-300 cursor-pointer">
                View All Products
              </button>
            </Link>
          </div>
          ...
          <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12">
            <div>
              ...
              <div className="flex space-x-4">
                <a href="#" className="w-10 h-10 flex items-center justify-center rounded-full bg-[#2c3a2a] text-white hover:bg-[#4a5a47] transition-colors duration-300 cursor-pointer">
            ...
            <div className="bg-white p-8 shadow-md">
              ...
              <form className="space-y-6">
                ...
                <button 
                  type="submit" 
                  className="bg-[#2c3a2a] text-white px-8 py-3 text-sm uppercase tracking-widest font-medium hover:bg-[#4a5a47] transition-colors duration-300 cursor-pointer"
                >
                  Send Message
                </button>
              </form>
